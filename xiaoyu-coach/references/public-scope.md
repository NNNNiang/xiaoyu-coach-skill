...
The GitHub skill should publish the reusable skeleton, not private operating assets.
...
- Real user videos, screenshots, pose overlays, or reports
...
Open-source the runnable skeleton. The paid product should provide convenience, stability, queueing, storage, continuity, and polished delivery.

## Release Checklist

1. Search for local absolute paths and personal names.
2. Search for private media extensions: `.mov`, `.mp4`, `.jpg`, `.png` unless they are synthetic assets.
